...
$site_top = "http://www.input-works.com/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "imai@input-works.com";
...
$Referer_check_domain = "http://www.input-works.com/";
...
$thanksPage = "http://www.input-works.com/";
...
function copyright(){
	echo '<p style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none"p>- Input Works Co., Ltd. -</p>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
